...
<center><div class="g-recaptcha" data-sitekey="6Ld1jTMUAAAAAOz1p3-YkszSpccJ9PROXMxLMb1g"></div></center>
<center><bold class='text-danger'>{{$errors->first('g-recaptcha-response')}}</bold></center>
<br/>
                        <div class="form-group">
